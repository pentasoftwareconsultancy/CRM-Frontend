      ...
      <div className="space-y-4 mb-6">
        ...
        {showFilters && (
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 animate-in slide-in-from-top-2">
            ...
            {/* Stacks on mobile */}
            <div className={`grid grid-cols-1 gap-4 ${(user.role === 'admin' || user.role === 'manager') ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
              <div>
                    ...
                    <tr key={lead.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-3 py-3">
                        <div className="flex items-center gap-2">
                          <span className={`px-2 py-1 rounded-full text-xs font-semibold ${lead.dealsCount > 0
