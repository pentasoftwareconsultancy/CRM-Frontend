...
import { ArrowLeft, Mail, Phone, MapPin, Building, MessageSquare, Briefcase, Edit, User as UserIcon } from 'lucide-react';
...
const LeadDetail = () => {
  ...
  // --- 5. UI Helpers ---
  if (loadingLead) return <div className="p-12 text-center text-slate-500">Loading lead details...</div>;
  ...
  const leadOwnerName = lead.assignedTo?.name || 'Unassigned';
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      {/* EDIT LEAD MODAL */}
      <Modal isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} title="Update Lead Information">
